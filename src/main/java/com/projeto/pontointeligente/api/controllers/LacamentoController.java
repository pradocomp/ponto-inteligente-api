...
public class LacamentoController {
	...
	private static final Logger log = LoggerFactory.getLogger(LacamentoController.class);
	...
	public ResponseEntity<Response<Page<LancamentoDto>>> listarPorFuncionarioId(
		...
		log.info("Buscando lancamento por ID fo funcionario: {}, página {}", funcionarioId, pag);
		Response<Page<LancamentoDto>> response = new Response<Page<LancamentoDto>>();

		Pageable paging = PageRequest.of(pag, this.qtdPorPagina, Sort.by(ord).ascending());
		Page<Lancamento> lancamentos = this.lancamentoService.buscarPorFuncionarioId(funcionarioId, paging);
		Page<LancamentoDto> lancamentosDto = lancamentos.map(lancamento -> converterUtils.converterLancamentoDto(lancamento));
	...
	public ResponseEntity<Response<LancamentoDto>> listarPorId(@PathVariable("id") Long id) {
		...
		response.setData(converterUtils.converterLancamentoDto(lancamento.get()));
		return ResponseEntity.ok(response);
	}
	...
	public ResponseEntity<Response<LancamentoDto>> adicionar(@Valid @RequestBody LancamentoDto lancamentoDto,
		...
		Lancamento lancamento = converterUtils.converterDtoParaLancamento(lancamentoDto, result);
		...
		response.setData(converterUtils.converterLancamentoDto(lancamento));
		return ResponseEntity.ok(response);
	}
