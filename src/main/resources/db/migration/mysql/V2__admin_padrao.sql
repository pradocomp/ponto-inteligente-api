INSERT INTO EMRPESA (id, cnpj, data_atualizacao, data_criacao, razao_social) 
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'pradocomp@gmail.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
